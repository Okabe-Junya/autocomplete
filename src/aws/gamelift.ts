...
const completionSpec: Fig.Spec = {
  ...
  subcommands: [
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          description: "Amazon GameLift Servers Anywhere configuration options",
          args: {
            name: "structure",
          },
        },
        ...
        {
          name: "--player-gateway-configuration",
          description:
    ...
    {
      name: "describe-container-group-port-mappings",
      description:
    ...
    {
      name: "get-player-connection-details",
      description:
    ...
    },
    {
      ...
      options: [
        ...
        {
          name: "--priority-configuration-override",
          description:
    ...
    },
    {
      ...
      options: [
        ...
        {
          name: "--managed-capacity-configuration",
          description:
