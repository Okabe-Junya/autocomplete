...
const completionSpec: Fig.Spec = {
  ...
  subcommands: [
    ...
    {
      name: "get-action",
      description: "Retrieves the description of a specific support action",
      options: [
        {
          name: "--action",
          description: "The name of the support action to retrieve",
          args: {
            name: "string",
          },
        },
    ...
    {
      name: "get-support-permit",
      description:
        "Retrieves the details of a support permit by its ARN or name",
      options: [
        {
          name: "--support-permit-identifier",
          description: "The ARN or name of the support permit to retrieve",
          args: {
            name: "string",
          },
        },
    ...
    {
      name: "list-support-permit-requests",
      description:
      ...
      options: [
        {
          name: "--support-case-display-id",
          description: "Filters the results by support case display identifier",
          args: {
            name: "string",
          },
        },
    ...
    },
    {
      ...
      description: "Lists the tags associated with a support permit resource",
      options: [
        {
          name: "--resource-arn",
    ...
    },
    {
      ...
      options: [
        ...
        {
          name: "--tags",
          description: "The tags to add to the resource. Maximum of 50 tags",
          args: {
            name: "map",
          },
        },
    ...
    {
      name: "untag-resource",
      description: "Removes one or more tags from a support permit resource",
      options: [
        {
          name: "--resource-arn",
