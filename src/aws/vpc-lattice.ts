  ...
  subcommands: [
    ...
    },
    {
      ...
      options: [
        ...
        {
          name: "--domain-verification-identifier",
          description:
    ...
    },
    {
      ...
      options: [
        ...
        {
          name: "--resource-config-dns-resolution",
          description:
    ...
    },
    {
      ...
      options: [
        ...
        {
          name: "--dns-options",
          description: "DNS options for the service network VPC association",
          args: {
            name: "structure",
          },
        },
    ...
    },
    {
      ...
      description: "Deletes the specified domain verification",
      options: [
        {
          name: "--domain-verification-identifier",
          description: "The ID of the domain verification to delete",
          args: {
            name: "string",
          },
        },
    ...
    },
    {
      ...
      description: "Retrieves information about a domain verification.ß",
      options: [
        {
          name: "--domain-verification-identifier",
          description: "The ID or ARN of the domain verification to retrieve",
          args: {
            name: "string",
          },
        },
    ...
    },
    {
      ...
      description: "Lists the domain verifications",
      options: [
        {
          name: "--cli-input-json",
          description:
    ...
    },
    {
      ...
      options: [
        ...
        {
          name: "--resource-configuration-group-identifier",
          description: "The ID of the resource configuration of type Group",
          args: {
            name: "string",
          },
        },
        {
          name: "--domain-verification-identifier",
          description: "The domain verification ID",
          args: {
            name: "string",
          },
        },
    ...
    },
    {
      ...
      options: [
        ...
        {
          name: "--domain-name",
          description: "The domain name to verify ownership for",
          args: {
            name: "string",
          },
        },
        {
          name: "--tags",
          description: "The tags for the domain verification",
          args: {
            name: "map",
          },
        },
