  ...
  subcommands: [
    {
      ...
      options: [
        {
          name: "--session-arn",
          description: "Amazon Resource Name (ARN) for the session",
          args: {
            name: "string",
          },
        },
    ...
    },
    {
      ...
      options: [
        ...
        {
          name: "--tags",
          description: "Tags you want to attach to the team",
          args: {
            name: "map",
          },
        },
    ...
    },
    {
      ...
      options: [
        {
          name: "--identity-source-parameters",
          description:
        ...
        {
          name: "--tags",
          description: "Tag you want to attach to the identity source",
          args: {
            name: "map",
          },
        },
    ...
    },
    {
      ...
      options: [
        {
          name: "--identity-source-arn",
          description: "Amazon Resource Name (ARN) for identity source",
          args: {
            name: "string",
          },
        },
    ...
    },
    {
      ...
      options: [
        {
          name: "--arn",
          description: "Amaazon Resource Name (ARN) for the team",
          args: {
            name: "string",
          },
        },
    ...
    },
    {
      ...
      description: "Returns details for an approval team",
      options: [
        {
          name: "--arn",
    ...
    },
    {
      ...
      options: [
        {
          name: "--identity-source-arn",
          description: "Amazon Resource Name (ARN) for the identity source",
          args: {
            name: "string",
          },
        },
    ...
    },
    {
      ...
      options: [
        {
          name: "--policy-version-arn",
          description: "Amazon Resource Name (ARN) for the policy",
          args: {
            name: "string",
          },
        },
    ...
    },
    {
      ...
      description: "Returns details about a policy for a resource",
      options: [
        {
          name: "--resource-arn",
    ...
    },
    {
      ...
      description: "Returns a list of approval teams",
      options: [
        {
          name: "--cli-input-json",
          description:
    ...
    },
    {
      ...
      description: "Returns a list of policies for a resource",
      options: [
        {
          name: "--resource-arn",
          description: "Amazon Resource Name (ARN) for the resource",
    ...
    },
    {
      ...
      options: [
        {
          name: "--approval-team-arn",
          description: "Amazon Resource Name (ARN) for the approval team",
          args: {
            name: "string",
          },
        },
    ...
    },
    {
      ...
      description: "Returns a list of the tags for a resource",
      options: [
        {
          name: "--resource-arn",
          description: "Amazon Resource Name (ARN) for the resource",
    ...
    {
      name: "start-approval-team-baseline",
      description:
      ...
      options: [
        ...
        {
          name: "--approver-ids",
          description: "Array of approver IDs",
          args: {
            name: "list",
          },
        },
    ...
    },
    {
      ...
      options: [
        ...
        {
          name: "--tag-keys",
          description: "Array of tag key-value pairs that you want to untag",
          args: {
            name: "list",
          },
        },
