  ...
  subcommands: [
    {
      ...
      options: [
        ...
        {
          name: "--tags",
          description: "Tags to associate with the compliance inquiry resource",
          args: {
            name: "map",
          },
        },
    ...
    },
    {
      ...
      options: [
        {
          name: "--compliance-inquiry-id",
          description: "Unique resource ID for the compliance inquiry",
          args: {
            name: "string",
          },
        },
        {
          name: "--query-identifiers",
        ...
        },
        {
          ...
          description: "When true, include citations in the exported document",
        },
        {
          name: "--no-include-citations",
          description: "When true, include citations in the exported document",
        },
        {
          name: "--cli-input-json",
    ...
    },
    {
      ...
      description: "List available report versions for a given report",
      options: [
        {
          name: "--report-id",
          description: "Unique resource ID for the report resource",
