...
const completionSpec: Fig.Spec = {
  ...
  subcommands: [
    {
      name: "accept-connection-proposal",
      description:
      ...
      options: [
        ...
        {
          name: "--tags",
          description: "The tags to associate with the resulting Connection",
          args: {
            name: "map",
          },
        },
        {
          name: "--client-token",
          description: "Idempotency token used for the request",
          args: {
            name: "string",
          },
        },
    ...
    },
    {
      ...
      options: [
        ...
        {
          name: "--bandwidth",
          description: "The desired bandwidth of the requested Connection",
          args: {
            name: "string",
          },
        },
        ...
        {
          name: "--tags",
          description: "The tag to associate with the resulting Connection",
          args: {
            name: "map",
          },
        },
    ...
    },
    {
      ...
      options: [
        {
          name: "--identifier",
          description: "The identifier of the Connection to be deleted",
          args: {
            name: "string",
          },
        },
    ...
    {
      name: "describe-connection-proposal",
      description:
    ...
    },
    {
      ...
      options: [
        {
          name: "--identifier",
          description: "The identifier of the requested Connection",
          args: {
            name: "string",
          },
        },
    ...
    },
    {
      ...
      description: "Describes a specific Environment",
      options: [
        {
          name: "--id",
          description: "The identifier of the specific Environment to describe",
          args: {
            name: "string",
          },
        },
    ...
    },
    {
      ...
      options: [
        {
          name: "--arn",
          description: "The resource ARN for which to list tags",
          args: {
            name: "string",
          },
        },
    ...
    {
      name: "tag-resource",
      description: "Add new tags to the specified resource",
      options: [
        {
          name: "--arn",
          description:
        ...
        {
          name: "--tags",
          description: "A map of tags to apply to the specified resource",
          args: {
            name: "map",
          },
        },
    ...
    },
    {
      ...
      subcommands: [
        {
          name: "connection-available",
          description:
            "Wait until JMESPath query connection.state returns available when polling with ``get-connection``. It will poll every 30 seconds until a successful state has been reached. This will exit with a return code of 255 after 5 failed checks",
          options: [
            {
              name: "--identifier",
              description: "The identifier of the requested Connection",
        ...
        },
        {
          ...
          description:
            "Wait until JMESPath query connection.state returns deleted when polling with ``get-connection``. It will poll every 30 seconds until a successful state has been reached. This will exit with a return code of 255 after 5 failed checks",
          options: [
            {
              name: "--identifier",
              description: "The identifier of the requested Connection",
