  ...
  subcommands: [
    ...
    },
    {
      ...
      options: [
        ...
        {
          name: "--end-timestamp",
          description: "Timestamp when the responsibility transfer is to end",
          args: {
            name: "timestamp",
          },
        },
