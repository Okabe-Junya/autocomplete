...
const completionSpec: Fig.Spec = {
  ...
  subcommands: [
    ...
    },
    {
      ...
      description: "Returns information about a deployment pattern version",
      options: [
        {
          name: "--workload-name",
          description:
        ...
        {
          name: "--deployment-pattern-version-name",
          description: "The name of the deployment pattern version",
          args: {
            name: "string",
          },
        },
    ...
    },
    {
      ...
      description: "Lists the deployment pattern versions",
      options: [
        {
          name: "--workload-name",
          description:
    ...
    },
    {
      ...
      options: [
        ...
        {
          name: "--workload-version-name",
          description: "The name of the workload version",
          args: {
            name: "string",
          },
        },
