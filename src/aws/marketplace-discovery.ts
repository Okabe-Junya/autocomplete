  ...
  subcommands: [
    ...
    },
    {
      ...
      options: [
        {
          name: "--offer-set-id",
          description: "The unique identifier of the offer set to retrieve",
          args: {
            name: "string",
          },
        },
    ...
    },
    {
      ...
      options: [
        {
          name: "--search-text",
          description: "The search query text to find relevant listings",
          args: {
            name: "string",
          },
        },
