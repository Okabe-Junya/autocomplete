  ...
  subcommands: [
    ...
    },
    {
      ...
      options: [
        ...
        flag11637,
        flag11946,
        { name: "--recurse", description: "Upload directories recursively" },
        {
          name: "--scp-flag",
          description:
            "Extra flag to be sent to scp. This flag may be repeated",
          args: { name: "SCP_FLAG", description: "String", suggestions: [] },
        },
        flag14299,
        flag14975,
        flag15315,
