...
const flag3015: Fig.Option = {
  name: "--deployment-file",
  description: "path to the deployment file",
  args: { name: "DEPLOYMENT_FILE", description: "String", suggestions: [] },
};
const flag3017: Fig.Option = {
  name: "--deployment-object",
  description: "json string of the deploymentObject",
  args: { name: "DEPLOYMENT_OBJECT", description: "String", suggestions: [] },
};
const flag4552: Fig.Option = {
  name: "--etag",
  description: "etag of the deployment file",
...
const completionSpec: Fig.Spec = {
  ...
  subcommands: [
    {
      name: "deployments",
      description: "Manage Google Workspace Add-ons Deployments",
      subcommands: [
        {
          name: "create",
