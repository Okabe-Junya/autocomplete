  ...
  subcommands: [
    {
      ...
      description: "Manage Cloud Location resources",
      subcommands: [
        {
          name: "describe",
        ...
        {
          name: "list",
          description: "List cloudLocations",
          options: [
            flag42,
            flag46,
            flag1201,
        ...
        {
          name: "search",
          description: "Search cloudLocations",
          options: [
            flag42,
            flag46,
            flag1201,
            ...
            {
              name: "--query",
              description: "Query to use for searching Cloudlocations",
            ...
            flag11946,
            {
              ...
              description:
                "ID of the source_cloud_location or fully qualified identifier for the source_cloud_location.\n+\nTo set the `cloud_location` attribute:\n* provide the argument `--source-cloud-location` on the command line",
              args: {
                name: "SOURCE_CLOUD_LOCATION",
                description: "String",
                suggestions: [],
              },
            },
