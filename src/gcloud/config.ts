  ...
  subcommands: [
    {
      ...
      subcommands: [
        ...
        {
          name: "rename",
          description: "Renames a named configuration",
          options: [
            flag42,
            flag46,
            flag1201,
            ...
            {
              name: "--new-name",
              description: "Specifies the new name of the configuration",
              args: {
                name: "NEW_NAME",
                description: "String",
                suggestions: [],
          ...
          args: {
            name: "CONFIGURATION_NAME",
            description: "Name of the configuration to rename",
          },
        },
      ],
    },
    {
      name: "get",
      description: "Print the value of a Google Cloud CLI property",
      options: [
        flag42,
        flag46,
        flag1201,
    ...
    {
      name: "set",
      description: "Set a Google Cloud CLI property",
      options: [
        flag42,
        flag46,
        flag1201,
      ...
      args: [
        ...
        { name: "VALUE", description: "Value to be set" },
      ],
    },
    {
      name: "unset",
      description: "Unset a Google Cloud CLI property",
      options: [
        flag42,
        flag46,
        flag1201,
