...
const flag7278: Fig.Option = {
  name: "--location",
  description:
    "The location id of the traceScope resource.\n+\nTo set the `location` attribute:\n* provide the argument `trace_scope` on the command line with a fully specified name;\n* provide the argument `--location` on the command line",
  args: { name: "LOCATION", description: "String", suggestions: [] },
};
...
const completionSpec: Fig.Spec = {
  ...
  subcommands: [
    {
      name: "scopes",
      description: "Manage Scope resources",
      subcommands: [
        {
          name: "describe",
    ...
    {
      name: "trace-scopes",
      description: "Manage Trace Scope resources",
      subcommands: [
        {
          name: "create",
          description: "Create traceScopes",
          options: [
            flag42,
            flag46,
            flag1201,
          ...
          args: {
            name: "TRACE_SCOPE",
            description:
              "ID of the traceScope or fully qualified identifier for the traceScope.\n+\nTo set the `trace_scope` attribute:\n* provide the argument `trace_scope` on the command line",
          },
        },
        {
          name: "delete",
          description: "Delete traceScopes",
          options: [
            flag42,
            flag46,
            flag1201,
        ...
        {
          name: "describe",
          description: "Describe traceScopes",
          options: [
            flag42,
            flag46,
            flag1201,
        ...
        {
          name: "update",
          description: "Update traceScopes",
          options: [
            flag42,
            flag46,
            flag1201,
