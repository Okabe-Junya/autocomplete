...
const completionSpec: Fig.Spec = {
  name: "bq",
  description: "Manage Bq resources",
  subcommands: [
    {
      name: "migration-workflows",
      description: "Manage Migration Workflow resources",
      subcommands: [
        {
          name: "create",
          description: "create migration workflows",
          options: [
            flag42,
            flag46,
            {
            ...
            {
              name: "--config-file",
              description: "Path to the migration workflows config file",
              args: {
                name: "CONFIG_FILE",
                description: "String",
                suggestions: [],
            ...
            {
              name: "--location",
              description: "Location of the migration workflow",
              args: {
                name: "LOCATION",
                description: "String",
                suggestions: [],
        ...
        {
          name: "delete",
          description: "Delete migration workflows",
          options: [
            flag42,
            flag46,
            flag1201,
        ...
        {
          name: "describe",
          description: "Describe migration workflows",
          options: [
            flag42,
            flag46,
            flag1201,
